...
public class Gnomos {
		...
		public void caer() {
			this.y += 0.10; //la velocidad en la que baja en el eje y 
		}
		...
		public boolean colisionaAbajoGnomo(Islas[] islas) {
		    for (Islas isla : islas) {
		    	...
		    	if (isla != null) {
		    		...
		    		if(Math.abs(this.bordeInferior - isla.getBordeSuperior())< 10) {
			             System.out.println("Colisión de gnomo detectada con isla"); //Lo puse para verificar que habia colision
		    		    // if(Math.abs(this.bordeIzq - isla.getBordeDer())< 10) {
			             return true;
		    		   //  }
		    		}
		    		// && 
